...
if __name__ == '__main__':
    ...
    #test: python3 msi_segment.py --file /usr/local/hdd/rita/msimaging/190927_AR_ZT13_Lipids/190927_AR_ZT13_Lipids.imzML --minus_background 0
    ...
    argument_parser.add_argument("--minus_background", help="subtract background spectra", action='store_true', required=False)
    ...
    for specStart in start:
        ...
        if minus_background:
            ...
            for region in imze.get_region_ids():
                xs = (imze.get_region_range(region)[0][0],imze.get_region_range(region)[0][1])
                ys = (imze.get_region_range(region)[1][0],imze.get_region_range(region)[1][1])
